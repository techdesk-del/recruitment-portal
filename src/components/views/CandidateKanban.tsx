...
export const CandidateKanban: React.FC = () => {
  ...
  return (
    <div className="h-full flex flex-col space-y-4 animate-fade-in min-h-0">
      ...
      <div className="flex-1 min-h-0 flex items-stretch gap-4 overflow-x-auto pb-2">
        {columns.map((col) => {
            ...
            >
              ...
              <div className="flex-1 min-h-0 overflow-y-auto space-y-3 pr-1">
                {colCandidates.length === 0 ? (
                  <div className="h-full flex flex-col items-center justify-center py-10 px-4 text-center border-2 border-dashed border-slate-300 rounded-xl bg-white/50 min-h-[140px]">
